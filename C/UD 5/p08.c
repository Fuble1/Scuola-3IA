/*  Realizzare un programma C che richiede in input un valore numerico compreso tra 5 e 15, presenta un breve menu con le seguenti voci:
    1. Genera matrice casuale e calcola il valor medio.
    2. Disegna il triangolo inferiore con numeri casuali.
    3. Richiedi N valori, comunicando al termine minimo, massimo e numero di valori pari e dispari.
*/
